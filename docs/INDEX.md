...
| [21_行情事实与决策分层方案.md](21_行情事实与决策分层方案.md) | 行情工具事实边界；上下文方向已转入文档 22 |
| [22_Pi式上下文管理架构.md](22_Pi式上下文管理架构.md) | 当前 Pi 式本地事件日志、幂等执行、token 压缩与跨会话取证架构及实施状态 |
| [23_行情工具LLM展示层中文替换方案.md](23_行情工具LLM展示层中文替换方案.md) | 行情工具原始事实与 LLM 可见中文展示的分层方案 |
