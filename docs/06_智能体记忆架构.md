...
> **归档状态（2026-09-20）**：本文件包含已退役的 Direct Context/摘要记忆方案，不再作为施工依据。当前实现请以 [00_项目架构.md](00_项目架构.md) 和 [22_Pi式上下文管理架构.md](22_Pi式上下文管理架构.md) 为准。
...
> 补充更新（2026-07-13）：历史上的进程内 `snapshot_manager` 旁路已删除；分析快照只以 MemoryAPI `last_snapshot` checkpoint 为准。目录分层见 [`00_项目架构.md`](00_项目架构.md)。
...
- **总架构与目录分层**：[`00_项目架构.md`](00_项目架构.md)
- 数据库初始化：[`20_数据库初始化指南.md`](20_数据库初始化指南.md)
