...
- profile_update：当用户明确表达交易偏好、风险态度、持仓想法、风格变化时使用（例如“我偏好右侧交易”、“我现在风险更高”、“我最近偏多头”、“我改成短线风格”）。此时 task_type 应为 "profile_update"，required_tools 可填 ["profile"] 或留空（由 orchestrator 自动包含画像工具）
"""
