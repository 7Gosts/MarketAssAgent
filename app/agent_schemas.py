...
from app.route_context import ROUTER_FALLBACK_INTERVAL, ROUTER_FALLBACK_SYMBOL
...
class AgentRequest:
    ...
    default_symbol: str = ROUTER_FALLBACK_SYMBOL  # fallback 常量（实际由 planner 运行时推导）
    default_interval: str = ROUTER_FALLBACK_INTERVAL  # fallback 常量（实际由 planner 运行时推导）
    ...
    def from_dict(cls, d: dict[str, Any]) -> "AgentRequest":
        return cls(
            ...
            default_symbol=str(d.get("default_symbol") or ROUTER_FALLBACK_SYMBOL),
            default_interval=str(d.get("default_interval") or ROUTER_FALLBACK_INTERVAL),
    ...
    def from_feishu(
        ...
        *,
        ...
        return cls(
            ...
            text=text,
            user_id=open_id,
            default_symbol=str(default_symbol or ""),
            default_interval=str(default_interval or ""),
            context=ctx,
        )
    ...
    def from_http(
        ...
        *,
        request_id: str,
        text: str,
        default_symbol: str = ROUTER_FALLBACK_SYMBOL,
        default_interval: str = ROUTER_FALLBACK_INTERVAL,
