...
FORBIDDEN_PATHS = [
    ...
    "tests/test_prompts_storage_key.py",
    "adapters",
    "renderers",
    "presenters",
    "formatters",
...
FORBIDDEN_IMPORT_PATTERNS = [
    ...
    r"\bfrom\s+core\.planner\s+import\b",
    r"\bimport\s+core\.planner\b",
    r"\bfrom\s+core\.planner_prompt\s+import\b",
    r"\bimport\s+core\.planner_prompt\b",
    r"\bfrom\s+core\.orchestrator\s+import\b",
    r"\bimport\s+core\.orchestrator\b",
    r"\bfrom\s+core\.prompts\s+import\b",
    ...
    r"\bfrom\s+interfaces\.renderers\.\w+\s+import\b",
    r"\bfrom\s+interfaces\.\w+\s+import\b",
]
